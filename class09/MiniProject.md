...
We have ‘r nrow(wisc.df)’ samples in the
    dataset
...
![](MiniProject_files/figure-gfm/unnamed-chunk-12-1.png)<!-- -->

``` r
plot(wisc.pr$x[,1], wisc.pr$x[,2],col = diagnosis,xlab = "PC1", ylab = "PC2")
```

![](MiniProject_files/figure-gfm/unnamed-chunk-13-1.png)<!-- -->

``` r
plot(wisc.pr$x[,1], wisc.pr$x[,3],col = diagnosis,xlab = "PC1", ylab = "PC3")
```

![](MiniProject_files/figure-gfm/unnamed-chunk-14-1.png)<!-- -->

``` r
plot(wisc.pr)
```

![](MiniProject_files/figure-gfm/unnamed-chunk-15-1.png)<!-- -->
...
![](MiniProject_files/figure-gfm/unnamed-chunk-16-1.png)<!-- -->
...
![](MiniProject_files/figure-gfm/unnamed-chunk-20-1.png)<!-- -->
...
![](MiniProject_files/figure-gfm/unnamed-chunk-26-1.png)<!-- -->
...
![](MiniProject_files/figure-gfm/unnamed-chunk-29-1.png)<!-- -->

``` r
plot(wisc.pr$x[,1:2], col=grps)
```

![](MiniProject_files/figure-gfm/unnamed-chunk-30-1.png)<!-- -->
...
![](MiniProject_files/figure-gfm/unnamed-chunk-31-1.png)<!-- -->
...
![](MiniProject_files/figure-gfm/unnamed-chunk-33-1.png)<!-- -->
